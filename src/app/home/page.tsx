...
import { DemoHome } from "@/components/demo/demo-page";
...
export default function HomePage() {
  return <PageShell active="나의 홈" eyebrow="YOUR READING SPACE" title="오늘, 한 페이지 더 넓어지는 나." description="책과 생각이 쌓이는 나만의 공간입니다.">{configured() ? <HomeClient /> : <DemoHome />}</PageShell>;
}
