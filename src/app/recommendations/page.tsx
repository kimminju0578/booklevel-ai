...
import { DemoRecommendations } from "@/components/demo/demo-page";
...
export default function RecommendationsPage() {
  return <PageShell active="추천" eyebrow="READY FOR YOUR NEXT CHAPTER" title="지금의 나에게, 다음 한 권." description="취향을 넘어 새로운 이해로 이어지는 책을 만나세요.">{configured() ? <RecommendationsClient /> : <DemoRecommendations />}</PageShell>;
}
