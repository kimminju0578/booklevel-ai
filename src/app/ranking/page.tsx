...
import { DemoRanking } from "@/components/demo/demo-page";
...
export default function RankingPage() {
  return <PageShell active="" eyebrow="READ · THINK · GROW" title="이번 시즌, 어디까지 왔을까요?" description="책을 많이 읽는 것만으로는 충분하지 않아요. 이해하고, 쓰고, 다시 생각한 시간이 함께 반영됩니다.">{configured() ? <RankingClient /> : <DemoRanking />}</PageShell>;
}
