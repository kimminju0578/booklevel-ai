...
export function DemoCoach() {
  ...
  async function evaluate(isRetry = false) {
    ...
    inFlight.current = true; setState(isRetry ? "retry" : "loading"); setMessage("");
